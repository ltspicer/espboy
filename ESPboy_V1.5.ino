...
void displaySettingsMenu() {
  ...
  // 4 -> Minesweeper Minen
  displayButtonAndText(1, 44, "Minesweeper Minen", '1');
  // 5 -> Hi-Score löschen
  displayButtonAndText(1, 55, "Hiscores loeschen", '2');
  // 6 -> Volume
  displayButtonAndText(1, 66, "Volume", '3');
  // 7 -> WLAN
  displayButtonAndText(1, 77, "WLAN", '4');
  // 8 -> Changelog
  displayButtonAndText(1, 88, "Changelog", '5');
  // 8 -> Abbruch
  displayButtonAndText(1, 99, "Abbruch", 'A');
}
...
void deleteHiscores() {
  ...
  displayButtonAndText(1, 52, "Abbruch", 'A');
  while (true) {
    autoPowerOff();
