...
void displayMenu() {
  ...
  displayButtonAndText(1, smallDisplay ? 90 : 170, "Hiscores", '*');
...
void reversi() {
  ...
  uint16_t downArrowY = smallDisplay ? 103 : 159;
...
void minesweeper() {
  ...
  // Titel
  tft->setTextSize(smallDisplay ? 2 : 4);
  tft->setCursor(smallDisplay ? 10 : 20, 1);
  tft->print(F("Minesweeper"));
  tft->setTextSize(smallDisplay ? 1 : 2);

  // Anzahl Minen anzeigen
  tft->setCursor(smallDisplay ? 32 : 64,
                 smallDisplay ? 23 : 46);
  ...
  // Taste 6 (rechts)
  displayButtonAndText(
    smallDisplay ? 120 : 240,
    smallDisplay ? 80 : 160,
    "",
    '6');
  drawBitmapScaled(
    smallDisplay ? 132 : 264,
    smallDisplay ? 80 : 160,
    rightBitmap, 8, 8, iconColor);
  ...
  drawBitmapScaled(
    smallDisplay ? 78 : 156,
    smallDisplay ? 103 : 206,
    downBitmap, 8, 8, iconColor);
